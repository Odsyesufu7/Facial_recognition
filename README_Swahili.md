...
s haitumiki rasmi, watumiaji muhimu wamechapisha maagizo ya jinsi ya kusakinisha maktaba hii:

   * [Mwongozo wa usakinishaji wa Windows 10 wa @masoudr (dlib + face_recognition)](https://github.com/Odsyesufu7/face_recognition/issues/175#issue-257710508)

#### Inasakinisha picha ya Mashine Pepe iliyosanidiwa awali

   * [Pakua picha ya VM iliyosanidiwa awali](https://medium.com/@ageitgey/try-deep-learning-in-python-now-with-a-fully-pre-configured-vm-1d97d4c3e9b) (kwa VMware Player au VirtualBox).
...
* `face_recognition` - Tambua nyuso katika picha au folda iliyojaa
    picha.
* `utambuzi_wa_uso` - Tafuta nyuso katika picha au folda iliyojaa picha.
...
Tazama [mfano huu](https://github.com/Odyesufu7/face_recognition/blob/master/exa

mples/tafuta_faces_in_picture.py)
  ili kuijaribu.

Unaweza pia kuchagua kuingia katika muundo sahihi zaidi wa utambuzi wa nyuso unaotegemea mafunzo kwa kina.
...
Ikiwa una picha nyingi na GPU, unaweza pia
...
* [Tambua nyuso na kiainishaji cha majirani wa K-karibu zaidi](https://github.com/Odsyesufu/face_recognition/blob/master/examples/face_recognition_knn.py)
* [Jifunze picha nyingi kwa kila mtu kisha utambue nyuso kwa kutumia SVM](https://github.com/Odsyesufu7/face_recognition/blob/master/examples/face_recognition_svm.py)
